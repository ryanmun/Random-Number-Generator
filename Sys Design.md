...
easily understand. 
- Javascript was used to handle the game's mechanics, such as :
...
# Testing plan
- during test stratgy,environment used (codepen) allows us to test the code at each stage as we progress 
